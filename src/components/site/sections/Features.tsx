...
const ITEMS = [
  {
    ...
    text: "Professional recruitment services built on transparency and trust.",
  },
  {
    icon: Globe2,
    title: "Global Network",
    text: "Connecting talent with opportunities across multiple countries.",
  },
  {
    icon: UserCheck,
    title: "Ethical Recruitment",
    text: "Following legal and ethical recruitment standards.",
  },
  {
    icon: Handshake,
    title: "End-to-End Support",
    text: "Supporting clients throughout the recruitment process.",
  },
];
