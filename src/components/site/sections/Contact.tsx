      ...
      <div className="mx-auto max-w-7xl px-4 py-16 md:py-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            We're happy to answer your questions about overseas employment, partnerships, and our
            recruitment process.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {TILES.map(({ icon: Icon, label, lines, href }) => {
            ...
            const cls =
              "rounded-2xl border border-border bg-cream-soft p-6 transition-shadow hover:shadow-[0_18px_40px_-25px_rgba(14,75,58,0.3)]";
            return href ? (
              <a
                key={label}
                href={href}
